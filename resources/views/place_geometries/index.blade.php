...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h4>Listing Geometries</h4></div>
                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="row">
                          ...
                          <div class="col-md-5 mb-3 text-right" style="margin-top: 8px;">
                              <br>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{ $geometry->geometry_name }}</td>
                              <td><span class="badge badge-success float-right">{{ $geometry->geometry_type }}</span></td>
                              <td>Yes</td>
                              <td>
                                <!-- Call to action buttons -->
                                <ul class="list-inline m-0">
                                    <li class="list-inline-item">
                                        <a href="{{ route('pgeometry.create') }}">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="{{ route('pgeometry.edit', $geometry->id)}}">
                                    ...
                                    <li class="list-inline-item">
                                        <button class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="MapView"><i class="fa fa-map-marker"></i></button>
                                    </li>
                                </ul>
                              </td>
                              <!-- <td><a href="{{ route('pgeometry.edit', $geometry->id)}}" class="btn btn-primary">Edit</a></td>
                              <td>
                                  <form action="{{ route('pgeometry.destroy', $geometry->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
